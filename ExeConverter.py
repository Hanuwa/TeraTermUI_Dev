...
nuitka_command = (
    ...
    r'--include-data-file="'+project_directory+r'\translations\english.json=english.json" '     
    r'--include-data-file="'+project_directory+r'\translations\spanish.json=spanish.json" '                                                

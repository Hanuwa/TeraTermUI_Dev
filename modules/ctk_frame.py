...
class CTkFrame(CTkBaseClass):
    ...
    def configure(self, require_redraw=False, **kwargs):
        ...
        if "fg_color" in kwargs:
            new_fg_color = self._check_color_type(kwargs.pop("fg_color"), transparency=True)
            if new_fg_color != self._fg_color:
                ...
                for child in self.winfo_children():
                    if isinstance(child, CTkBaseClass):
                        child.configure(bg_color=new_fg_color)

        if "bg_color" in kwargs and self._fg_color == "transparent":
            new_bg_color = kwargs.get("bg_color")
            for child in self.winfo_children():
                if isinstance(child, CTkBaseClass):
                    child.configure(bg_color=new_bg_color)
    ...
    def bind(self, sequence=None, command=None, add=True):
        ...
        if sequence is not None and command is not None:
            self._bound_commands[sequence] = command
    ...
    def unbind(self, sequence=None, funcid=None):
        ...
        if sequence in self._bound_commands:
            del self._bound_commands[sequence]

...
class CTkBaseClass(tkinter.Frame, CTkAppearanceModeBaseClass, CTkScalingBaseClass):
    ...
    def __init__(self,
        ...
        # Store a weak reference to the master instead of a strong reference
    ...
    def place(self, **kwargs):
        ...
        self._store_geometry_call(super().place, **kwargs)
    ...
    def pack(self, **kwargs):
        ...
        """
        self._store_geometry_call(super().pack, **kwargs)
    ...
    def grid(self, **kwargs):
        ...
        """
        self._store_geometry_call(super().grid, **kwargs)
